...
<body class="pattern animated fadeIn">
		  ...
		  <div class="modal-dialog">
		    ...
		    <div class="modal-content">
		      <div class="modal-header">
		        ...
		        <h3 class="color-blue modal-title">Visas</h3>
		      </div>
		      <div class="modal-body">
		      	<h4 class="color-blue">Heading 1</h4>
		        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>		      	
		      	<h4 class="color-blue">Heading 2</h4>
		      	<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
		      	<h4 class="color-blue">Heading 3</h4>
		      	<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
		      </div>
	...
	<div class="content">
		...
		<div class="container">	
			...
			<div class="col-sm-12">	
				<div class="row">
					<!-- BREADCRUMB DIV -->
					<div class="col-sm-6 col-xs-12">
						<div class="col-sm-push-0 col-sm-9 col-xs-12 col-sm-pull-0">
							<ol class="breadcrumb">
					...
					<!-- Search-box DIV -->				
					<div class="col-sm-6 col-xs-12">
						<div class="col-sm-push-0 col-sm-10 col-xs-12 col-sm-pull-0">
							<form action="" method="">
								<input type="text" class="searchbox"  data-toggle="modal" data-target="#searchModel">
							</form>
						</div>
					</div>
				</div>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="banner innerPages_banner">
					<!-- TOP BANNER -->
					<div class="scroller">
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-push-1 col-lg-10 col-lg-pull-1">
						<h2 class="color-blue text-center">The Bliss of Naran</h2>
			...
			<div class="col-lg-12">
				<div class="row margins">
					...
					<div class="col-lg-4 col-sm-6 col-xs-12">
						<div class="zoom">
							<div class="text-center famous_events_div">
					...
					<div class="col-lg-4 col-sm-6 col-xs-12">
						<div class="zoom">
							<div class="text-center famous_events_div">
								<img id="siteseeing_normal" class="image_normal events_image_normal" src="./images/siteseeing.png" />
								<img id="siteseeing_hover" class="image_hover" src="./images/img-3.jpg" />	
								<div class="normal_details">
									<div class="has_wrapper">
										<h2 class="color-black">Site Seeing</h2>
										<p>In Naran</p>
										<p>15 differnet site seeing spots</p>
									</div>
								</div>				
								<div class="has_bottom hover_details">	
									<h2>Site Seeing</h2>
		...
		<div class="white_bg padding">
			...
			<div class="container-fluid">
				<div class="row">
					<h2 class="text-center">Discover Activities by Interest</h2>
							...
							<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
								<div class="other_activities_box">
									<a href="#">
										<!-- LEFT IMAGE DIV -->
										<div class="col-xs-6">
											<img class="img" src="images/img-4.jpg" />
										</div>	
										<!-- LEFT TEXT DIV -->
										<div class="col-xs-6">
											<h4 class="color-black">Hunar Mela</h4>
		...
		<div class="white_bg padding">
			<div class="container-fluid">
				<div class="row">
					<h2 class="color-blue text-center">Survival Guide</h2>
						<div class="col-lg-push-1 col-lg-10 col-lg-pull-1">
							<!-- VISAS dIV -->
