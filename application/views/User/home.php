				...
				<div class="col-sm-6">
					<a href="<?php echo base_url();?>discover">
						<div class="left-landing-div">
							<object type="image/svg+xml" data="images/User/home_page_illlustrations-03.svg" width="50%" height="auto">
							 	<param name="src" value="images/User/home_page_illlustrations-03.svg">
							</object>					
				...
				<div class="col-sm-6">
					<a href="#">
						<div class="right-landing-div">
							<object type="image/svg+xml" data="images/User/home_page_illlustrations-02-cropped.svg" width="53%" height="auto">
							 	<param name="src" value="images/User/home_page_illlustrations-02-cropped.svg">
							</object>
