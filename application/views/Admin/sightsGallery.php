...
<section class="content-header">
  <h1>
    <?php echo $sight_name[0]['name'];?> Gallery
  </h1>
  <ol class="breadcrumb">
...
<section class="content">
    <div class="box box-danger">
        <div class="box-body">
			...
			echo form_open_multipart('Admin/Sights/addGallery/'.$sight_id,'class="form-horizontal col-sm-12 col-md-12 col-md-offset-0" id="gallery_form"'); 				            ?>
		        <div class="box-body">
			...
			<table id="spots_table" class="table table-bordered table-striped">
				...
				?>
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo base_url();?>Admin/Sights/deleteSightImage/<?php echo $value['sight_id'];?>/<?php echo $value['id'];?>" onClick="return confirm('Are you sure to delete?')" class="btn btn-danger btn-sm">Delete</a>
                      </td>
                    </tr>
                <?php
					$a++; 
