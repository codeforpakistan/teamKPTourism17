    ...
    <div class="box box-danger">
        <div class="box-body">
		    	...
		    	<div class="box-body">
                    ...
                    <div class="form-group">
					  <label for="name" class="col-sm-3 control-label">Sight Name : </label>
					  <div class="col-sm-6">
						<?php 
						$data = array(
									  'name'        => 'name',
									  'id'          => 'name',
									  'value'       => set_value('name',@$sight_data->name),
                    ...
                    <label for="address" class="col-sm-3 control-label">Address : </label>
					  <div class="col-sm-6">
						...
						$data = array(
									  'name'        => 'address',
									  'id'          => 'address',
									  'value'       => set_value('address',@$sight_data->address),
									  'class'       => 'form-control input-lg',
									  );
						echo form_input($data);
                    ...
                    <div class="form-group">
					  ...
					  <div class="col-sm-6">
						...
						$data = array(
									  'name'        => 'contact',
									  'id'          => 'contact',
									  'value'       => set_value('contact',@$sight_data->contact),
									  'class'       => 'form-control input-lg',
									  );
						echo form_input($data);
                    ...
                    <div class="form-group">
					  ...
					  <div class="col-sm-6">
						...
						$data = array(
									  'name'        => 'email',
									  'id'          => 'email',
									  'value'       => set_value('email',@$sight_data->email),
									  'class'       => 'form-control input-lg',
									  );
						echo form_input($data);
                  ...
                  <div class="form-group">
					  ...
					  <div class="col-sm-6">
						...
						$data = array(
									  'name'        => 'website',
									  'id'          => 'website',
									  'value'       => set_value('website',@$sight_data->website),
									  'class'       => 'form-control input-lg',
									  );
						echo form_input($data);
                  ...
                  <div class="form-group">
					  ...
					  <div class="col-sm-6">
						...
						$data = array(
									  'name'        => 'open_timing',
									  'id'          => 'open_timing',
									  'value'       => set_value('open_timing',@$sight_data->open_timing),
									  'class'       => 'form-control input-lg',
									  );
						echo form_input($data);
                  ...
                  <div class="form-group">
					  ...
					  <div class="col-sm-6">
						...
						$data = array(
									  'name'        => 'close_timing',
									  'id'          => 'close_timing',
									  'value'       => set_value('close_timing',@$sight_data->close_timing),
									  'class'       => 'form-control input-lg',
									  );
						echo form_input($data);
                   ...
                   <div class="form-group">
                    <label for="rating" class="col-sm-3 control-label">Rating : </label>
					  <div class="col-sm-6">
						...
						if(!empty($sight_data->rating))
						{
							$selected = $sight_data->rating;	
						}
						else{
                  ...
                  <div class="form-group">
					  ...
					  <div class="col-sm-6">
						...
						$data = array(
									  'name'        => 'latitude',
									  'id'          => 'latitude',
									  'value'       => set_value('latitude',@$sight_data->latitude),
									  'class'       => 'form-control input-lg',
									  );
						echo form_input($data);
                  ...
                  <div class="form-group">
					  ...
					  <div class="col-sm-6">
						...
						$data = array(
									  'name'        => 'longitude',
									  'id'          => 'longitude',
									  'value'       => set_value('longitude',@$sight_data->longitude),
									  'class'       => 'form-control input-lg',
									  );
						echo form_input($data);
                  ...
                  <div class="form-group">
					  ...
					  <div class="col-sm-6">
						...
						$data = array(
									  'name'        => 'header_image',
									  'id'          => 'header_image',
									  'value'       => set_value('header_image',@$sight_data->header_image),
									  'class'       => 'input-lg',
									  );
                    ...
                    <div class="form-group">
					  ...
					  <div class="col-sm-6">
						...
						if(!empty($sight_data->category))
						{
							$selected = $sight_data->category;	
						}
						else{
                    ...
                    <div class="form-group">
					  ...
					  <div class="col-sm-6">
						...
						if(!empty($sight_data->type))
						{
							$selected = $sight_data->type;	
						}
						else{
                    ...
                    <div class="form-group">
					  ...
					  <div class="col-sm-6">
						...
						unset($options);
						if(!empty($sight_data->status))
						{
							$selected = $sight_data->status;	
						}
						else{
...
$(document).ready(function(e) {
	...
	$('textarea').html("<?php 
	if(!empty($sight_data->description))
	{
		echo $sight_data->description;
	}
	else
	{
