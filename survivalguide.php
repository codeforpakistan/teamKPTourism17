...
<body class="pattern">
	<div class="survival_container">
		...
		<div class="row" data-sticky_parent>
			<!-- SIDEBAR MENU -->
			<div id="sidebar" class="col-sm-3 col-xs-12" data-sticky_column>
				<div id="cssmenu">
					<ul>
					   <li><a href='#money-and-cost'><span class="list-icon"><img src="images/money-and-costs.png"></span><span class="list-text">Money and Costs</span></a></li>
					   <li><a href='#best-time-to-go'><span class="list-icon"><img src="images/money-and-costs.png"></span><span class="list-text">When to go and Weather</span></a></li>
					   <li class='has-sub'><a href='#visas'><span class="list-icon"><img src="images/air-ntk.png"></span><span class="list-text">Getting to </span><span class="region-selected"></span></a>
					      <ul>
					   ...
					   <li><a href='#getting-around'><span class="list-icon"><img src="images/car-ntk.png"></span><span class="list-text">Getting around </span><span class="region-selected"></span></a></li>
					   <li><a href='#health'><span class="list-icon"><img src="images/health.png"></span><span class="list-text">Health & Safety</span></a></li>
					   <li class='last'><a href='#advice'><span class="list-icon"><img src="images/disabilities-ntk.png"></span><span class="list-text">Advice for Travellers</span></a></li>
					</ul>
				</div>			 
			</div>
			<!-- END OF SIDEBAR MENU -->	
			...
			<div class="col-sm-9 col-xs-12" data-sticky_column>
				<!-- START OF BEST TIME -->
